...
export default function InwestorPage() {
  ...
  const packages = [
    ...
    },
    {
      ...
      price: "od 300 000 zł",
      features: [
        "Schron dla 8-12 osób",
        "Zaawansowana wentylacja NBC",
        "System filtracji i klimatyzacji",
        "Autonomiczne źródło energii",
        "Drzwi pancerne klasy VII",
        "System monitoringu",
        "Gwarancja 15 lat",
      ],
      highlighted: true,
    },
    {
      ...
      features: [
        ...
        "System NBC + dekontaminacja",
        "Wykończenie premium",
        "Inteligentny system zarządzania",
        "Własna studnia i oczyszczalnia",
        "Gwarancja 20 lat",
      ],
    },
  ]
